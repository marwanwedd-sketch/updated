...
const AboutSection: React.FC = () => {
  const { t } = useLanguage();
  return (
    <section id="about" className="py-14 sm:py-20 lg:py-24 bg-pet-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="text-center mb-10 sm:mb-16 relative">
          ...
          <span className="inline-flex items-center justify-center gap-2 px-5 py-2 rounded-full bg-white shadow-pet text-forest-green font-bold text-sm mb-4 sm:mb-6 tracking-wide uppercase border border-forest-green/10">
            <PawPrint size={18} className="text-terracotta/70" />
            {t('about.badge')}
          </span>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 xl:gap-20 items-center">
          <div className="mb-10 sm:mb-12 lg:mb-0">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6">
              <div className="p-4 sm:p-5 rounded-[1.25rem] sm:rounded-[1.5rem] bg-white shadow-pet border border-forest-green/5 group/card hover:shadow-pet-hover transition-all duration-300">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 rounded-full bg-forest-green/10 flex items-center justify-center shrink-0 text-forest-green group-hover/card:scale-110 transition-transform">
                    <CuteDog size={28} />
                  </div>
              ...
              <div className="p-4 sm:p-5 rounded-[1.25rem] sm:rounded-[1.5rem] bg-white shadow-pet border border-forest-green/5 group/card hover:shadow-pet-hover transition-all duration-300">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-12 h-12 rounded-full bg-terracotta/10 flex items-center justify-center shrink-0 text-terracotta group-hover/card:scale-110 transition-transform">
                    <CuteCat size={28} />
                  </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="p-4 sm:p-6 rounded-[1.25rem] sm:rounded-[1.5rem] bg-white shadow-pet border border-forest-green/5 hover:shadow-pet-hover transition-shadow">
              <h4 className="font-bold text-forest-green mb-2 text-base sm:text-lg flex items-center gap-2">
                <span className="w-9 h-9 rounded-full bg-terracotta/10 flex items-center justify-center shrink-0">
