...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-14 sm:py-20 lg:py-24 bg-gradient-to-b from-pet-cream via-warm-sand/20 to-pet-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        <div className="text-center mb-10 sm:mb-16">
          <div className="flex justify-center gap-3 mb-4">
            <CuteDog size={32} className="text-forest-green/40" />
            <CuteCat size={32} className="text-terracotta/40" />
          </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 xl:gap-20">
          ...
          <div className="mb-10 sm:mb-16 lg:mb-0 space-y-4 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="group flex items-start p-4 sm:p-6 bg-white rounded-[1.25rem] sm:rounded-[1.5rem] shadow-pet hover:shadow-pet-hover transition-all hover:-translate-y-0.5 border border-forest-green/5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-terracotta/10 rounded-full flex items-center justify-center text-terracotta shrink-0 mr-4 sm:mr-5 group-hover:scale-110 transition-transform">
              ...
              <div className="group flex items-start p-4 sm:p-6 bg-white rounded-[1.25rem] sm:rounded-[1.5rem] shadow-pet hover:shadow-pet-hover transition-all hover:-translate-y-0.5 border border-forest-green/5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-forest-green/10 rounded-full flex items-center justify-center text-forest-green shrink-0 mr-4 sm:mr-5 group-hover:scale-110 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="group flex items-start p-4 sm:p-6 bg-white rounded-[1.25rem] sm:rounded-[1.5rem] shadow-pet hover:shadow-pet-hover transition-all hover:-translate-y-0.5 border border-forest-green/5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-terracotta/10 rounded-full flex items-center justify-center text-forest-green shrink-0 mr-4 sm:mr-5 group-hover:scale-110 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white p-5 sm:p-8 lg:p-14 rounded-[1.5rem] sm:rounded-[2rem] shadow-pet border border-forest-green/10">
